...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void CreateJadwal(com.ventapratama.listjadwalkeretaapi.Jadwal data){
    ...
    public List<com.ventapratama.listjadwalkeretaapi.Jadwal> ReadJadwal() {
        List<com.ventapratama.listjadwalkeretaapi.Jadwal> listAlt = new ArrayList<com.ventapratama.listjadwalkeretaapi.Jadwal>();
        String selectQuery = "SELECT * FROM " + tb_alat;
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (cursor.moveToFirst()) {
            do {
                com.ventapratama.listjadwalkeretaapi.Jadwal data = new com.ventapratama.listjadwalkeretaapi.Jadwal();
    ...
    public int UpdateJadwal (com.ventapratama.listjadwalkeretaapi.Jadwal data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(tb_alat_kode, data.get_kode());
        values.put(tb_alat_nama, data.get_nama());
    ...
    public void DeleteJadwal(com.ventapratama.listjadwalkeretaapi.Jadwal data){
        SQLiteDatabase db = this.getWritableDatabase();
